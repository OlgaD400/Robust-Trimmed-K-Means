...
def make_figure(dataset:str, f1_rtkm, f1_kmor, f1_neo, me_rtkm, me_kmor, me_neo,
                min_rtkm, min_kmor, min_neo, max_rtkm, max_kmor, max_neo,
                alpha_vals) -> None:
